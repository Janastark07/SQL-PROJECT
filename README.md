...
CREATE PROCEDURE update_employee_salary( E_EMPLOYEE_ID INT, E_NEW_SALARY INT ) BEGIN -- Update the salary of the employee with the given EMPLOYEE_ID UPDATE employee SET SALARY = E_NEW_SALARY WHERE EMPLOYEE_ID = E_EMPLOYEE_ID; END //
...
SELECT (FEES_AMOUNT - FEES_PAY ) AS 'BALANCE AMOUNT '
FROM 
    student_fees
WHERE 
